...
def Forward(prefix, maximum_distance, model_prefix, window_width=106, nchannels=1):
    ...
    probabilities = model.predict_generator(CandidateGenerator(prefix, segmentation, image, candidates, maximum_distance, window_width, nchannels), ncandidates, max_q_size=1)
