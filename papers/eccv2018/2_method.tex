...
\begin{figure}[t]
	...
	\end{minipage}
	\caption{Example skeletons (in black) extracted from segments using a variant of the TEASER algorithm~\cite{sato2000teasar}. These skeletons not only well-capture the shape of the segmentation, but also provide end-points useful for region merging proposals.}
