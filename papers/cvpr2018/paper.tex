...
%%%%%%%%% ABSTRACT
\begin{abstract}
Advancements in electron microscopy image acquisition have created massive connectomics datasets which are petabytes in size and make manual segmentation infeasible. 
